window.__EC_DOC_option_yAxis = {
  ...
  "gridIndex": {
    "desc": "<p>y 轴所在的 grid 的索引，默认位于第一个 grid。</p>\n"
  },
  "alignTicks": {
    "desc": "<p>在多个 y 轴为数值轴的时候，可以开启该配置项自动对齐刻度。只对<code class=\"codespan\">&#39;value&#39;</code>和<code class=\"codespan\">&#39;log&#39;</code>类型的轴有效。</p>\n"
  },
  "position": {
  ...
  "realtimeSort": {
    "desc": "<p>用于制作动态排序柱状图。设为 <code class=\"codespan\">true</code> 时，表示 Y 轴开启实时排序效果，仅当 X 轴的 <a href=\"#yAxis.type\">type</a> 是 <code class=\"codespan\">&#39;value&#39;</code> 时有效。</p>\n<p>需要配合其他配置项共同实现动态排序柱状图效果，具体参见<a href=\"http://localhost/echarts-website/handbook/zh/how-to/chart-types/bar/bar-race\" target=\"_blank\">动态排序柱状图</a>教程。</p>\n"
  },
  "sortSeriesIndex": {
    "desc": "<p>动态排序柱状图用于排序的系列 id。目前只支持一个系列的柱状图排序效果，所以这个值只能取 0。仅当 Y 轴 <a href=\"#yAxis.realtimeSort\">realtimeSort</a> 为 <code class=\"codespan\">true</code> 并且 <a href=\"#yAxis.type\">type</a> 是 <code class=\"codespan\">&#39;value&#39;</code> 时有效。</p>\n<p>需要配合其他配置项共同实现动态排序柱状图效果，具体参见<a href=\"http://localhost/echarts-website/handbook/zh/how-to/chart-types/bar/bar-race\" target=\"_blank\">动态排序柱状图</a>教程。</p>\n"
  },
  "type": {
  ...
  "axisLine.onZeroAxisIndex": {
    "desc": "<p>当有双轴时，可以用这个属性手动指定，在哪个轴的 0 刻度上。</p>\n"
  },
  "axisLine.symbol": {
  ...
  "axisTick.lineStyle.color": {
    "desc": "<p>刻度线的颜色，默认取 <a href=\"#yAxis.axisTick.lineStyle.color\">axisTick.lineStyle.color</a>。</p>\n"
  },
  ...
  "zlevel": {
    "desc": "<p>Y 轴所有图形的 zlevel 值。</p>\n<p><code class=\"codespan\">zlevel</code>用于 Canvas 分层，不同<code class=\"codespan\">zlevel</code>值的图形会放置在不同的 Canvas 中，Canvas 分层是一种常见的优化手段。我们可以把一些图形变化频繁（例如有动画）的组件设置成一个单独的<code class=\"codespan\">zlevel</code>。需要注意的是过多的 Canvas 会引起内存开销的增大，在手机端上需要谨慎使用以防崩溃。</p>\n<p><code class=\"codespan\">zlevel</code> 大的 Canvas 会放在 <code class=\"codespan\">zlevel</code> 小的 Canvas 的上面。</p>\n"
  },
  "z": {
    "desc": "<p>Y 轴组件的所有图形的<code class=\"codespan\">z</code>值。控制图形的前后顺序。<code class=\"codespan\">z</code>值小的图形会被<code class=\"codespan\">z</code>值大的图形覆盖。</p>\n<p><code class=\"codespan\">z</code>相比<code class=\"codespan\">zlevel</code>优先级更低，而且不会创建新的 Canvas。</p>\n"
  }
}
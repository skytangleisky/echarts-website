window.__EC_DOC_option_legend = {
  ...
  "itemStyle": {
    "desc": "<p>图例的图形样式。其属性的取值为 <code class=\"codespan\">&#39;inherit&#39;</code> 时，表示继承系列中的属性值。</p>\n"
  },
  "itemStyle.color": {
  ...
  "lineStyle": {
    "desc": "<p>图例图形中线的样式，用于诸如折线图图例横线的样式设置。其属性的取值为 <code class=\"codespan\">&#39;inherit&#39;</code> 时，表示继承系列中的属性值。</p>\n"
  },
  "lineStyle.color": {
    "desc": "\n\n<p>线的颜色。</p>\n<blockquote>\n<p>支持使用<code class=\"codespan\">rgb(255,255,255)</code>，<code class=\"codespan\">rgba(255,255,255,1)</code>，<code class=\"codespan\">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href=\"#color\">option.color</a></p>\n</blockquote>\n",
    "uiControl": {
  ...
  "symbolRotate": {
    "desc": "<p>图形旋转角度，类型为 <code class=\"codespan\">number | &#39;inherit&#39;</code>。如果为 <code class=\"codespan\">&#39;inherit&#39;</code>，表示取系列的 <code class=\"codespan\">symbolRotate</code>。</p>\n"
  },
  "formatter": {
    "desc": "<p>用来格式化图例文本，支持字符串模板和回调函数两种形式。</p>\n<p>示例：</p>\n<pre><code class=\"lang-ts\">// 使用字符串模板，模板变量为图例名称 {name}\nformatter: &#39;Legend {name}&#39;\n// 使用回调函数\nformatter: function (name) {\n    return &#39;Legend &#39; + name;\n}\n</code></pre>\n"
  },
  "selectedMode": {
  ...
  "inactiveBorderWidth": {
    "desc": "\n\n<p>图例关闭时的描边粗细。如果为 <code class=\"codespan\">&#39;auto&#39;</code> 表示：如果系列存在描边，则取 2，如果系列不存在描边，则取 0。如果为 <code class=\"codespan\">&#39;inherit&#39;</code> 则表示：始终取系列的描边粗细。</p>\n",
    "uiControl": {
      "type": "color",
      "default": "#ccc"
    }
  ...
  "data.itemStyle": {
    "desc": "<p>图例项的图形样式。其属性的取值为 <code class=\"codespan\">&#39;inherit&#39;</code> 时，表示继承系列中的属性值。</p>\n"
  },
  ...
  "data.lineStyle": {
    "desc": "<p>图例项图形中线的样式，用于诸如折线图图例横线的样式设置。其属性的取值为 <code class=\"codespan\">&#39;inherit&#39;</code> 时，表示继承系列中的属性值。</p>\n"
  },
  ...
  "pageIcons.horizontal": {
    "desc": "<p><a href=\"#legend.orient\">legend.orient</a> 为 <code class=\"codespan\">&#39;horizontal&#39;</code> 时的翻页按钮图标。</p>\n<p>是一个数组，表示 <code class=\"codespan\">[previous page button, next page button]</code>。默认值为 <code class=\"codespan\">[&#39;M0,0L12,-10L12,10z&#39;, &#39;M0,0L-12,-10L-12,10z&#39;]</code>，。</p>\n<p>数组中每项，</p>\n<p>可以通过 <code class=\"codespan\">&#39;image://url&#39;</code> 设置为图片，其中 URL 为图片的链接，或者 <code class=\"codespan\">dataURI</code>。</p>\n<p>URL 为图片链接例如：</p>\n<pre><code>&#39;image://http://xxx.xxx.xxx/a/b.png&#39;\n</code></pre><p>URL 为 <code class=\"codespan\">dataURI</code> 例如：</p>\n<pre><code>&#39;image://data:image/gif;base64,&#39;\n</code></pre><p>可以通过 <code class=\"codespan\">&#39;path://&#39;</code> 将图标设置为任意的矢量路径。这种方式相比于使用图片的方式，不用担心因为缩放而产生锯齿或模糊，而且可以设置为任意颜色。路径图形会自适应调整为合适的大小。路径的格式参见 <a href=\"http://www.w3.org/TR/SVG/paths.html#PathData\" target=\"_blank\">SVG PathData</a>。可以从 Adobe Illustrator 等工具编辑导出。</p>\n<p>例如：</p>\n<pre><code>&#39;path://M30.9,53.2C16.8,53.2,5.3,41.7,5.3,27.6S16.8,2,30.9,2C45,2,56.4,13.5,56.4,27.6S45,53.2,30.9,53.2z M30.9,3.5C17.6,3.5,6.8,14.4,6.8,27.6c0,13.3,10.8,24.1,24.101,24.1C44.2,51.7,55,40.9,55,27.6C54.9,14.4,44.1,3.5,30.9,3.5z M36.9,35.8c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H36c0.5,0,0.9,0.4,0.9,1V35.8z M27.8,35.8 c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H27c0.5,0,0.9,0.4,0.9,1L27.8,35.8L27.8,35.8z&#39;\n</code></pre><p>参见 <a href=\"http://localhost/echarts-website/examples/zh/editor.html?c=pie-legend&amp;edit=1&amp;reset=1\" target=\"_blank\">滚动图例（垂直）</a> 或 <a href=\"http://localhost/echarts-website/examples/zh/editor.html?c=radar2&amp;edit=1&amp;reset=1\" target=\"_blank\">滚动图例（水平）</a>。</p>\n"
  },
  "pageIcons.vertical": {

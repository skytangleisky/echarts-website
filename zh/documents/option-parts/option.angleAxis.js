window.__EC_DOC_option_angleAxis = {
  ...
  "startAngle": {
    "desc": "\n\n<p>起始刻度的角度，默认为 90 度，即圆心的正上方。0 度为圆心的正右方。</p>\n<p>如下示例是 startAngle 为 45 的效果：</p>\n<iframe  data-src=\"http://localhost/echarts-website/examples/zh/view.html?c=doc-example/polar-start-angle&edit=1&reset=1\" width=\"400\" height=\"400\"></iframe>\n\n",
    "uiControl": {
      "type": "angle",
      "default": "90",
      "min": "-360",
  ...
  "clockwise": {
    "desc": "\n\n<p>刻度增长是否按顺时针，默认顺时针。</p>\n<p>如下示例是 clockwise 为 <code class=\"codespan\">false</code> （逆时针）的效果：</p>\n<iframe  data-src=\"http://localhost/echarts-website/examples/zh/view.html?c=doc-example/polar-anticlockwise&edit=1&reset=1\" width=\"400\" height=\"400\"></iframe>\n\n\n\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
  ...
  "axisTick.lineStyle.color": {
    "desc": "<p>刻度线的颜色，默认取 <a href=\"#angleAxis.axisTick.lineStyle.color\">axisTick.lineStyle.color</a>。</p>\n"
  },
  ...
  "zlevel": {
    "desc": "<p>角度轴所有图形的 zlevel 值。</p>\n<p><code class=\"codespan\">zlevel</code>用于 Canvas 分层，不同<code class=\"codespan\">zlevel</code>值的图形会放置在不同的 Canvas 中，Canvas 分层是一种常见的优化手段。我们可以把一些图形变化频繁（例如有动画）的组件设置成一个单独的<code class=\"codespan\">zlevel</code>。需要注意的是过多的 Canvas 会引起内存开销的增大，在手机端上需要谨慎使用以防崩溃。</p>\n<p><code class=\"codespan\">zlevel</code> 大的 Canvas 会放在 <code class=\"codespan\">zlevel</code> 小的 Canvas 的上面。</p>\n"
  },
  "z": {
    "desc": "<p>角度轴组件的所有图形的<code class=\"codespan\">z</code>值。控制图形的前后顺序。<code class=\"codespan\">z</code>值小的图形会被<code class=\"codespan\">z</code>值大的图形覆盖。</p>\n<p><code class=\"codespan\">z</code>相比<code class=\"codespan\">zlevel</code>优先级更低，而且不会创建新的 Canvas。</p>\n"
  }
}
window.__EC_DOC_option_visualMap_continuous = {
  ...
  "text": {
    "desc": "<p>两端的文本，如 <code class=\"codespan\">[&#39;High&#39;, &#39;Low&#39;]</code>。<a href=\"http://localhost/echarts-website/examples/zh/editor.html?c=doc-example/map-visualMap-continuous-text&amp;edit=1&amp;reset=1\" target=\"_blank\">参见例子</a>。</p>\n<p><code class=\"codespan\">text</code> 中的顺序，其实试试就知道。若要看详细的规则，参见 <a href=\"#visualMap.inverse\">visualMap.inverse</a>。</p>\n"
  },
  "textGap": {

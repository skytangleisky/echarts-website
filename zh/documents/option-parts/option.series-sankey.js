window.__EC_DOC_option_series_sankey = {
  ...
  "label": {
    "desc": "<p><code class=\"codespan\">label</code> 描述了每个矩形节点中文本标签的样式。</p>\n"
  },
  "label.show": {
    "desc": "\n\n<p>是否显示标签。</p>\n",
    "uiControl": {
  ...
  "data.value": {
    "desc": "<p>节点的值，可用来指定节点的纵向高度或横向的宽度。</p>\n"
  },
  "data.depth": {
    "desc": "<p>节点所在的层，取值从 0 开始。</p>\n"
  },
  "data.itemStyle": {
    "desc": "<p>该节点的样式。</p>\n"
  },
  ...
  "links.source": {
    "desc": "<p>边的<a href=\"#series-sankey.data.name\">源节点名称</a></p>\n"
  },
  "links.target": {
    "desc": "<p>边的<a href=\"#series-sankey.data.name\">目标节点名称</a></p>\n"
  },
  "links.value": {
    "desc": "<p>边的数值，决定边的宽度。</p>\n"
  },
  "links.lineStyle": {
    "desc": "<p>关系边的线条样式。</p>\n"
  },

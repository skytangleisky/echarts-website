window.__EC_DOC_option_xAxis = {
  ...
  "gridIndex": {
    "desc": "<p>The index of grid which the x axis belongs to. Defaults to be in the first grid.</p>\n"
  },
  "alignTicks": {
    "desc": "<p><code class=\"codespan\">alignTicks</code> turned on to automatically align ticks when multiple numeric x axes. Only available for axes of type <code class=\"codespan\">&#39;value&#39;</code> and <code class=\"codespan\">&#39;log&#39;</code>.</p>\n"
  },
  "position": {
  ...
  "offset": {
    "desc": "\n\n<p>Offset of x axis relative to default position. Useful when multiple x axis has same <a href=\"#xAxis.position\">position</a> value.</p>\n",
    "uiControl": {
      "type": "number",
      "step": "0.5"
    }
  ...
  "realtimeSort": {
    "desc": "<p><code class=\"codespan\">realtimeSort</code> is used to enable bar race if set to be <code class=\"codespan\">true</code>. It is only valid if the <a href=\"#xAxis.type\">type</a> of xAxis is <code class=\"codespan\">&#39;value&#39;</code>.</p>\n<p>It should be used along with other options to enable bar race. Please refer to <a href=\"http://localhost/echarts-website/handbook/en/how-to/chart-types/bar/bar-race\" target=\"_blank\">bar race</a> tutorial for more details.</p>\n"
  },
  "sortSeriesIndex": {
    "desc": "<p>The index of series used to sort in bar race. Since only one series is supported in bar race, <code class=\"codespan\">sortSeriesIndex</code> should always be <code class=\"codespan\">0</code>. It is only valid if <a href=\"#xAxis.realtimeSort\">realtimeSort</a> is <code class=\"codespan\">true</code> and <a href=\"#xAxis.type\">type</a> is <code class=\"codespan\">&#39;value&#39;</code>.</p>\n<p>It should be used along with other options to enable bar race. Please refer to <a href=\"http://localhost/echarts-website/handbook/en/how-to/chart-types/bar/bar-race\" target=\"_blank\">bar race</a> tutorial for more details.</p>\n"
  },
  "type": {
  ...
  "axisLine.onZeroAxisIndex": {
    "desc": "<p>When mutiple axes exists, this option can be used to specify which axis can be &quot;onZero&quot; to.</p>\n"
  },
  "axisLine.symbol": {
  ...
  "axisTick.lineStyle.color": {
    "desc": "<p>Color of axis label is set to be <a href=\"#xAxis.axisLine.lineStyle.color\">axisLine.lineStyle.color</a> by default.</p>\n"
  },
  ...
  "axisPointer.handle": {
    "desc": "<p>A button used to drag axisPointer. This feature is applicable in touch device. See <a href=\"http://localhost/echarts-website/examples/en/editor.html?c=line-tooltip-touch&amp;edit=1&amp;reset=1\" target=\"_blank\">example</a>.</p>\n"
  },
  ...
  "zlevel": {
    "desc": "<p><code class=\"codespan\">zlevel</code> value of all graphical elements in x axis.</p>\n<p><code class=\"codespan\">zlevel</code> is used to make layers with Canvas. Graphical elements with different <code class=\"codespan\">zlevel</code> values will be placed in different Canvases, which is a common optimization technique. We can put those frequently changed elements (like those with animations) to a separate <code class=\"codespan\">zlevel</code>. Notice that too many Canvases will increase memory cost, and should be used carefully on mobile phones to avoid crash.</p>\n<p>Canvases with bigger <code class=\"codespan\">zlevel</code> will be placed on Canvases with smaller <code class=\"codespan\">zlevel</code>.</p>\n"
  },
  "z": {
    "desc": "<p><code class=\"codespan\">z</code> value of all graphical elements in x axis, which controls order of drawing graphical components. Components with smaller <code class=\"codespan\">z</code> values may be overwritten by those with larger <code class=\"codespan\">z</code> values.</p>\n<p><code class=\"codespan\">z</code> has a lower priority to <code class=\"codespan\">zlevel</code>, and will not create new Canvas.</p>\n"
  }
}
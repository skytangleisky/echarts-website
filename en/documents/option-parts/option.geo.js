window.__EC_DOC_option_geo = {
  ...
  "map": {
    "desc": "<p>Map name registered in <a href=\"api.html#echarts.registerMap\" target=\"_blank\">registerMap</a>.</p>\n<p><strong>Use geoJSON</strong></p>\n<pre><code class=\"lang-ts\">$.get(&#39;map/china_geo.json&#39;, function (chinaJson) {\n    echarts.registerMap(&#39;china&#39;, {geoJSON: geoJson});\n    var chart = echarts.init(document.getElementById(&#39;main&#39;));\n    chart.setOption({\n        geo: [{\n            map: &#39;china&#39;,\n            ...\n        }]\n    });\n});\n</code></pre>\n<p>See also <a href=\"http://localhost/echarts-website/examples/en/editor.html?c=custom-hexbin\" target=\"_blank\">geoJSON hexbin</a>.</p>\n<p>The demo above shows that ECharts can uses <a href=\"http://geojson.org/\" target=\"_blank\">geoJSON</a> format as map outline. You can use third-party <a href=\"http://geojson.org/\" target=\"_blank\">geoJSON</a> data (like <a href=\"https://github.com/echarts-maps\" target=\"_blank\">maps</a>) and register them into ECharts.</p>\n<p><strong>Use SVG</strong></p>\n<pre><code class=\"lang-ts\">$.get(&#39;map/topographic_map.svg&#39;, function (svg) {\n    echarts.registerMap(&#39;topo&#39;, {svg: svg});\n    var chart = echarts.init(document.getElementById(&#39;main&#39;));\n    chart.setOption({\n        geo: [{\n            map: &#39;topo&#39;,\n            ...\n        }]\n    });\n});\n</code></pre>\n<p>See also <a href=\"http://localhost/echarts-website/examples/en/editor.html?c=geo-seatmap-flight\" target=\"_blank\">Flight Seatmap</a>.</p>\n<p>The demo above shows that SVG format can be used in ECharts. See more info in <a href=\"tutorial.html#SVG%20Base%20Map%20in%20Geo%20Coords%20and%20Map%20Series\" target=\"_blank\">SVG Base Map</a>.</p>\n"
  },
  "roam": {
  ...
  "projection": {
    "desc": "<p>For custom map projection, at least two methods <code class=\"codespan\">project</code>, <code class=\"codespan\">unproject</code> should be provided to calculate the coordinates after projection and before projection respectively.</p>\n<p>For example, for the Mercator projection.</p>\n<pre><code class=\"lang-ts\">series: {\n    type: &#39;map&#39;,\n    projection: {\n        project: (point) =&gt; [point[0] / 180 * Math.PI, -Math.log(Math.tan((Math.PI / 2 + point[1] / 180 * Math.PI) / 2))],\n        unproject: (point) =&gt; [point[0] * 180 / Math.PI, 2 * 180 / Math.PI * Math.atan(Math.exp(point[1])) - 90]\n    }\n}\n</code></pre>\n<p>In addition to our own implementation of the projection formula, we can also use exists projection implementations provided by third-party libraries such as <a href=\"https://github.com/d3/d3-geo\" target=\"_blank\">d3-geo</a>.</p>\n<pre><code class=\"lang-ts\">const projection = d3.geoConicEqualArea();\n// ...\nseries: {\n    type: &#39;map&#39;,\n    projection: {\n        project: (point) =&gt; projection(point),\n        unproject: (point) =&gt; projection.invert(point)\n    }\n}\n\n</code></pre>\n<p>Note: Custom projections are only useful when using <code class=\"codespan\">GeoJSON</code> as a data source.</p>\n"
  },
  "projection.project": {
    "desc": "<pre><code class=\"lang-ts\">(coord: [number, number]) =&gt; [number, number]\n</code></pre>\n<p>Projection of latitude and longitude coordinates to other coordinates.</p>\n"
  },
  "projection.unproject": {
    "desc": "<pre><code class=\"lang-ts\">(point: [number, number]) =&gt; [number, number]\n</code></pre>\n<p>Calculate the raw latitude and longitude coordinates from the projected coordinates</p>\n"
  },
  "projection.stream": {
    "desc": "<p>This property is mainly used to adapt the <a href=\"https://github.com/d3/d3-geo#streams\" target=\"_blank\">stream</a> interface used in <a href=\"https://github.com/d3/d3-geo\" target=\"_blank\">d3-geo</a>. After introducing stream, you can introduce both the <a href=\"https://bl.ocks.org/mbostock/3788999\" target=\"_blank\">Antimeridian Clipping</a> and <a href=\"https://bl.ocks.org/mbostock/3795544\" target=\"_blank\">Adaptive Sampling</a> algorithms implemented in <a href=\"https://bl.ocks.org/mbostock/3795544\" target=\"_blank\">d3-geo</a>.</p>\n<pre><code class=\"lang-ts\">const projection = d3.geoProjection((x, y) =&gt; ([x, y / 0.75]))\n    .rotate([-115, 0]);\n// ...\nseries: {\n    type: &#39;map&#39;,\n    projection: {\n        // We still need project and unproject when stream is provided.\n        project: (point) =&gt; projection(point),\n        unproject: (point) =&gt; projection.invert(point),\n        // We can directly use the stream method in d3 projection.\n        stream: projection.stream\n    }\n}\n</code></pre>\n<p>Note: <code class=\"codespan\">stream</code> is not required in the <code class=\"codespan\">projection</code>.</p>\n"
  },
  "center": {
    "desc": "<p>Center of current view-port, in longitude and latitude by default. Use the projected coordinates if <code class=\"codespan\">projection</code> is set.</p>\n<p>Example:</p>\n<pre><code class=\"lang-ts\">center: [115.97, 29.71]\n</code></pre>\n<pre><code class=\"lang-ts\">projection: {\n    projection: (pt) =&gt; project(pt)\n},\ncenter: project([115.97, 29.71])\n</code></pre>\n"
  },
  "aspectScale": {
    "desc": "<p>Used to scale aspect of geo. Will be ignored if <code class=\"codespan\">projection</code> is set.</p>\n<p>The final aspect is calculated by: <code class=\"codespan\">geoBoundingRect.width / geoBoundingRect.height * aspectScale</code>.</p>\n"
  },
  "boundingCoords": {
    "desc": "<p>Two dimension array. Define coord of left-top, right-bottom in layout box.</p>\n<pre><code class=\"lang-ts\">// A complete world map\nmap: &#39;world&#39;,\nleft: 0, top: 0, right: 0, bottom: 0,\nboundingCoords: [\n    // [lng, lat] of left-top corner\n    [-180, 90],\n    // [lng, lat] of right-bottom corner\n    [180, -90]\n],\n</code></pre>\n"
  },
  "zoom": {
